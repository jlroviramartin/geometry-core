 ...
 * @author joseluis
 */
public class VectorTemplates2 extends BaseTemplate {

    private final Template vector = load("pebble/vectors/Vector.pebble");
    private final Template vectorImp = load("pebble/vectors/VectorImp.pebble");

    private final Template buffvector = load("pebble/buffvectors/BuffVector.pebble");
    private final Template buffvectorImp = load("pebble/buffvectors/BuffVectorImp.pebble");
