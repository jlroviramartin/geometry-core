 ...
 */
public class Point2f : Tuple2f, Point2
{
...
//<editor-fold defaultstate="collapsed" desc="Point2">
    ...
    public Point2f add(BuffVector2f other)
    {
        return new Point2f((float)(getX() + other.getX()), (float)(getY() + other.getY()));
    }
    ...
    public Point2f sub(BuffVector2f other)
    {
        return new Point2f((float)(getX() - other.getX()), (float)(getY() - other.getY()));
    }
    ...
    public Vector2f VectorTo(BuffPoint2f other)
    {
        return new Vector2f((float)(other.getX() - getX()), (float)(other.getY() - getY()));
    }
    ...
    public Point2f lerp(BuffPoint2f other, double alpha)
    {
        return lineal(other, 1 - alpha, alpha);
    }
    ...
    public Point2f lineal(BuffPoint2f other, double alpha, double beta)
    {
        return new Point2f((float)(alpha * getX() + beta * other.getX()),
                           (float)(alpha * getY() + beta * other.getY()));
    }
    ...
    public Point2f VectorProjection(BuffVector2f where)
    {
        double dot = getX() * where.getX() + getY() * where.getY();
        double r = dot / where.GetLengthCuad();
