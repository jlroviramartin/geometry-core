 ...
 */
public class Point2d : Tuple2d, Point2
{
...
//<editor-fold defaultstate="collapsed" desc="Point2">
    ...
    public Point2d add(BuffVector2d other)
    {
        return new Point2d((double)(getX() + other.getX()), (double)(getY() + other.getY()));
    }
    ...
    public Vector2d VectorTo(BuffPoint2d other)
    {
        return new Vector2d((double)(other.getX() - getX()), (double)(other.getY() - getY()));
    }
    ...
    public Point2d lerp(BuffPoint2d other, double alpha)
    {
        return lineal(other, 1 - alpha, alpha);
    }
    ...
    public Point2d lineal(BuffPoint2d other, double alpha, double beta)
    {
        return new Point2d((double)(alpha * getX() + beta * other.getX()),
                           (double)(alpha * getY() + beta * other.getY()));
    }
    ...
    public Point2d VectorProjection(BuffVector2d where)
    {
        double dot = getX() * where.getX() + getY() * where.getY();
        double r = dot / where.GetLengthCuad();
