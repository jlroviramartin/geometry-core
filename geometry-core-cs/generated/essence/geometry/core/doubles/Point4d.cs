 ...
 */
public class Point4d : Tuple4d, Point4
{
...
//<editor-fold defaultstate="collapsed" desc="Point4">
    ...
    public Point4d add(BuffVector4d other)
    {
        return new Point4d((double)(getX() + other.getX()), (double)(getY() + other.getY()), (double)(getZ() + other.getZ()), (double)(getW() + other.getW()));
    }
    ...
    public Point4d sub(BuffVector4d other)
    {
        return new Point4d((double)(getX() - other.getX()), (double)(getY() - other.getY()), (double)(getZ() - other.getZ()), (double)(getW() - other.getW()));
    }
    ...
    public Vector4d VectorTo(BuffPoint4d other)
    {
        return new Vector4d((double)(other.getX() - getX()), (double)(other.getY() - getY()), (double)(other.getZ() - getZ()), (double)(other.getW() - getW()));
    }
    ...
    public Point4d lerp(BuffPoint4d other, double alpha)
    {
        return lineal(other, 1 - alpha, alpha);
    }
    ...
    public Point4d lineal(BuffPoint4d other, double alpha, double beta)
    {
        return new Point4d((double)(alpha * getX() + beta * other.getX()),
                           (double)(alpha * getY() + beta * other.getY()),
                           (double)(alpha * getZ() + beta * other.getZ()),
    ...
    public Point4d VectorProjection(BuffVector4d where)
    {
        double dot = getX() * where.getX() + getY() * where.getY() + getZ() * where.getZ() + getW() * where.getW();
        double r = dot / where.GetLengthCuad();
