 ...
 */
public class Tuple3b implements Cloneable, EpsilonEquatable<Tuple>, Tuple  {
...
//</editor-fold>
    ...
    public Tuple3b(Tuple3b tuple) {
        this.x = tuple.getX();
        this.y = tuple.getY();
        this.z = tuple.getZ();
    }

    public Tuple3b(BuffTuple3b tuple) {
        this.x = tuple.getX();
        this.y = tuple.getY();
        this.z = tuple.getZ();
    }
...
//<editor-fold defaultstate="collapsed" desc="Object">
    ...
    @Override
    public Tuple3b clone() throws CloneNotSupportedException {
        Tuple3b copy = (Tuple3b)super.clone();
        return copy;
    }
//</editor-fold>
