 ...
 */
public class Tuple2dList <T extends Tuple2d> extends AbstractList<T> {
...
//<editor-fold defaultstate="collapsed" desc="fields">
    ...
    private static final Logger LOG = Logger.getLogger(Tuple2dList.class.getName());
//</editor-fold>
     ...
     */
    public Tuple2dList(ConstructorFunction<T> constructor) {
     ...
     * @param constructor Tuple constructor.
     */
    public Tuple2dList(int size, ConstructorFunction<T> constructor) {
     ...
     * @return A new tuple.
     */
    protected T newTuple(double x, double y) {
        if (constructor == null) {
     ...
     */
    protected static Tuple2_Double toTuple(Tuple tuple) {
        if (tuple instanceof Tuple2_Double) {
            return (Tuple2_Double)tuple;
        }
...
//</editor-fold>
     ...
     */
    @FunctionalInterface
    protected static interface ConstructorFunction<T extends Tuple2d> {
        T invoke(double x, double y);
    }
}
