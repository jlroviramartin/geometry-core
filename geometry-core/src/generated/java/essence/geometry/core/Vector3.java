...
public interface Vector3 extends Tuple {
     ...
     */
    Vector3 addAndSet(Vector3 other);
     ...
     * @return {@code result = this - other}
     */
    Vector3 subAndSet(Vector3 other);
     ...
     * @return result.
     */
    Vector3 simpleMulAndSet(Vector3 other);
     ...
     * @return result.
     */
    Vector3 simpleDivAndSet(Vector3 other);
     ...
     * @return {@code this * alpha + other * (1 - alpha)}
     */
    Vector3 lerpAndSet(Vector3 other, double alpha);
     ...
     * @return {@code this * alpha + other * beta}
     */
    Vector3 linealAndSet(Vector3 other, double alpha, double beta);
     ...
     * @return {@code this x other}
     */
    Vector3 crossAndSet(Vector3 other);
     ...
     * @return {@code this.scalarProjection(where) . where.getUnit()}
     */
    default Vector3 vectorProjectionAndSet(Vector3 where) {
        Vector3 u = where.getUnit();
        return u.mul(dot(u));
    }
}
