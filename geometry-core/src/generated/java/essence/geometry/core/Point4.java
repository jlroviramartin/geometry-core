...
public interface Point4 extends Tuple {
     ...
     * @return Distance.
     */
    default double getDistance(Point4 other) {
     ...
     */
    default Point4 lerp(Point4 other, double alpha) {
     ...
     */
    Point4 addAndSet(Vector4 other);
     ...
     * @return {@code this = this - other}
     */
    Point4 subAndSet(Vector4 other);
     ...
     */
    default Point4 lerpAndSet(Point4 other, double alpha) {
        return lineal(other, 1 - alpha, alpha);
    }
     ...
     */
    Point4 linealAndSet(Point4 other, double alpha, double beta);
     ...
     */
    Point4 vectorProjectionAndSet(Vector4 where);
}
