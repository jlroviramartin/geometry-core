...
public interface Point2 extends Tuple {
     ...
     * @return Distance.
     */
    default double getDistance(Point2 other) {
     ...
     */
    default Point2 lerp(Point2 other, double alpha) {
     ...
     */
    Point2 addAndSet(Vector2 other);
     ...
     * @return {@code this = this - other}
     */
    Point2 subAndSet(Vector2 other);
     ...
     */
    default Point2 lerpAndSet(Point2 other, double alpha) {
        return lineal(other, 1 - alpha, alpha);
    }
     ...
     */
    Point2 linealAndSet(Point2 other, double alpha, double beta);
     ...
     */
    Point2 vectorProjectionAndSet(Vector2 where);
}
