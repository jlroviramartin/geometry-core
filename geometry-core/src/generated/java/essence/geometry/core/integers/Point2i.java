...
public class Point2i extends Tuple2i implements Point2 {
    ...
    */
    ...
    public double invLerp(Point2 other, Point2 pLerp) {
        Tuple2_Integer _other = toTuple(other);
        Tuple2_Integer _pLerp = toTuple(pLerp);
...
//</editor-fold>
    ...
    //<editor-fold defaultstate="collapsed" desc="Point2">
    @Override
    public Point2i addAndSet(Vector2 other) {
        Tuple2_Integer _other = toTuple(other);
    ...
    public Point2i addAndSet(Vector2i other) {
        set(getX() + other.getX(), getY() + other.getY());
        return this;
    }

    @Override
    public Point2i subAndSet(Vector2 other) {
        Tuple2_Integer _other = toTuple(other);
    ...
    public Point2i subAndSet(Vector2i other) {
        set(getX() - other.getX(), getY() - other.getY());
        return this;
    }

    @Override
    public Point2i lerpAndSet(Point2 other, double alpha) {
        return linealAndSet(other, 1 - alpha, alpha);
    }

    public Point2i lerpAndSet(Point2i other, double alpha) {
        return linealAndSet(other, 1 - alpha, alpha);
    }

    @Override
    public Point2i linealAndSet(Point2 other, double alpha, double beta) {
        Tuple2_Integer _other = toTuple(other);
    ...
    @Override
    public Point2i vectorProjectionAndSet(Vector2 where) {
        set(new Vector2i(this).vectorProjectionAndSet(where));
        return this;
    }

    public Point2i vectorProjectionAndSet(Vector2i where) {
        set(new Vector2i(this).vectorProjectionAndSet(where));
        return this;
    }
//</editor-fold>
