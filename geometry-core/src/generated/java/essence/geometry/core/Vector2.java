...
public interface Vector2 extends Tuple {
     ...
     */
    default Vector2 lerp(Vector2 other, double alpha) {
     ...
     */
    default double scalarProjection(Vector2 where) {
     ...
     */
    Vector2 addAndSet(Vector2 other);
     ...
     * @return {@code result = this - other}
     */
    Vector2 subAndSet(Vector2 other);
     ...
     * @return result.
     */
    Vector2 simpleMulAndSet(Vector2 other);
     ...
     * @return result.
     */
    Vector2 simpleDivAndSet(Vector2 other);
     ...
     * @return {@code this * alpha + other * (1 - alpha)}
     */
    Vector2 lerpAndSet(Vector2 other, double alpha);
     ...
     * @return {@code this * alpha + other * beta}
     */
    Vector2 linealAndSet(Vector2 other, double alpha, double beta);
     ...
     * @return Rotated vector.
     */
    Vector2 setRotate(double angle);
     ...
     * @return Rotated vector.
     */
    Vector2 setRotateAndScale(double angle, double len);
     ...
     * @return {@code this.scalarProjection(where) . where.getUnit()}
     */
    default Vector2 vectorProjectionAndSet(Vector2 where) {
        Vector2 u = where.getUnit();
        return u.mul(dot(u));
    }
}
