 ...
 */
public interface BuffPoint3 extends Point3, BuffTuple {
     ...
     */
    BuffPoint3 addAndSet(Vector3 other);
     ...
     * @return {@code this = this - other}
     */
    BuffPoint3 subAndSet(Vector3 other);
     ...
     */
    BuffPoint3 lerpAndSet(Point3 other, double alpha);
     ...
     */
    BuffPoint3 linealAndSet(Point3 other, double alpha, double beta);
     ...
     */
    BuffPoint3 vectorProjectionAndSet(Vector3 where);
}
