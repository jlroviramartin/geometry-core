...
/**
 * A {@code Vector4} is a 4 dimensional collection of values
 * that represents a vector.
 */
public interface Vector4 extends Tuple {
     ...
     */
    Vector4 simpleMul(Vector4 other);
     ...
     * @return {@code (this.x / other.x, this.y / other.y, ...)}
     */
    Vector4 simpleDiv(Vector4 other);
     ...
     *                result = |V1| / |V2|}
     */
    double invLerp(Vector4 other, Vector4 vLerp);
     ...
     */
    Vector4 lineal(Vector4 other, double alpha, double beta);
     ...
     */
    Vector4 vectorProjection(Vector4 where);
     ...
     */
    Vector4 addAndSet(Vector4 other);
     ...
     * @return {@code result = this - other}
     */
    Vector4 subAndSet(Vector4 other);
     ...
     * @return result.
     */
    Vector4 simpleMulAndSet(Vector4 other);
     ...
     * @return result.
     */
    Vector4 simpleDivAndSet(Vector4 other);
     ...
     * @return {@code this * alpha + other * (1 - alpha)}
     */
    Vector4 lerpAndSet(Vector4 other, double alpha);
     ...
     * @return {@code this * alpha + other * beta}
     */
    Vector4 linealAndSet(Vector4 other, double alpha, double beta);
     ...
     * @return {@code this.scalarProjection(where) . where.getUnit()}
     */
    default Vector4 vectorProjectionAndSet(Vector4 where) {
        Vector4 u = where.getUnit();
        return u.mul(dot(u));
    }
}
