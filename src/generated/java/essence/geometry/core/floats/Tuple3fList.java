 ...
 */
public class Tuple3fList <T extends Tuple3f> extends AbstractList<T> {
...
//<editor-fold defaultstate="collapsed" desc="fields">
    ...
    private static final Logger LOG = Logger.getLogger(Tuple3fList.class.getName());
//</editor-fold>
     ...
     */
    public Tuple3fList(ConstructorFunction<T> constructor) {
     ...
     * @param constructor Tuple constructor.
     */
    public Tuple3fList(int size, ConstructorFunction<T> constructor) {
     ...
     * @return A new tuple.
     */
    protected T newTuple(float x, float y, float z) {
        if (constructor == null) {
     ...
     */
    protected static Tuple3_Float toTuple(Tuple tuple) {
        if (tuple instanceof Tuple3_Float) {
            return (Tuple3_Float)tuple;
        }
...
//</editor-fold>
     ...
     */
    @FunctionalInterface
    protected static interface ConstructorFunction<T extends Tuple3f> {
        T invoke(float x, float y, float z);
    }
}
