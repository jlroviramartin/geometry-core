...
//<editor-fold defaultstate="collapsed" desc="Vector4">
    ...
    @Override
    public Vector4d vectorProjection(Vector4 where) {
...
//<editor-fold defaultstate="collapsed" desc="Vector4">
    ...
    @Override
    public Vector4d addAndSet(Vector4 other) {
        Tuple4_Double _other = toTuple(other);
    ...
    public Vector4d addAndSet(Vector4d other) {
        set(getX() + other.getX(), getY() + other.getY(), getZ() + other.getZ(), getW() + other.getW());
        return this;
    }

    @Override
    public Vector4d subAndSet(Vector4 other) {
        Tuple4_Double _other = toTuple(other);
    ...
    public Vector4d subAndSet(Vector4d other) {
        set(getX() - other.getX(), getY() - other.getY(), getZ() - other.getZ(), getW() - other.getW());
        return this;
    }

    @Override
    public Vector4d simpleMulAndSet(Vector4 other) {
        Tuple4_Double _other = toTuple(other);
    ...
    public Vector4d simpleMulAndSet(Vector4d other) {
        set(getX() * other.getX(), getY() * other.getY(), getZ() * other.getZ(), getW() * other.getW());
        return this;
    }

    @Override
    public Vector4d simpleDivAndSet(Vector4 other) {
        Tuple4_Double _other = toTuple(other);
    ...
    public Vector4d simpleDivAndSet(Vector4d other) {
        set(getX() / other.getX(), getY() / other.getY(), getZ() / other.getZ(), getW() / other.getW());
        return this;
    }

    @Override
    public Vector4d mulAndSet(double v) {
        set((double)(getX() * v), (double)(getY() * v), (double)(getZ() * v), (double)(getW() * v));
        return this;
    }

    @Override
    public Vector4d divAndSet(double v) {
        set((double)(getX() / v), (double)(getY() / v), (double)(getZ() / v), (double)(getW() / v));
        return this;
    }

    @Override
    public Vector4d negAndSet() {
        set(- getX(), - getY(), - getZ(), - getW());
        return this;
    }

    @Override
    public Vector4d absAndSet() {
        set(Math.abs(getX()), Math.abs(getY()), Math.abs(getZ()), Math.abs(getW()));
        return this;
    }

    @Override
    public Vector4d lerpAndSet(Vector4 other, double alpha) {
        linealAndSet(other, 1 - alpha, alpha);
        return this;
    }

    public Vector4d lerpAndSet(Vector4d other, double alpha) {
        linealAndSet(other, 1 - alpha, alpha);
        return this;
    }

    @Override
    public Vector4d linealAndSet(Vector4 other, double alpha, double beta) {
        Tuple4_Double _other = toTuple(other);
    ...
    @Override
    public Vector4d vectorProjectionAndSet(Vector4 where) {
    ...
    public Vector4d vectorProjectionAndSet(Vector4d where) {
        double r = dot(where) / where.getLengthCuad();
        set(where);
        mulAndSet(r);
        return this;
