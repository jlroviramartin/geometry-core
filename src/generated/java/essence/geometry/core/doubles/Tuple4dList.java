 ...
 */
public class Tuple4dList <T extends Tuple4d> extends AbstractList<T> {
...
//<editor-fold defaultstate="collapsed" desc="fields">
    ...
    private static final Logger LOG = Logger.getLogger(Tuple4dList.class.getName());
//</editor-fold>
     ...
     */
    public Tuple4dList(ConstructorFunction<T> constructor) {
     ...
     * @param constructor Tuple constructor.
     */
    public Tuple4dList(int size, ConstructorFunction<T> constructor) {
        array = new double[size * 4];
     ...
     * @return A new tuple.
     */
    protected T newTuple(double x, double y, double z, double w) {
        if (constructor == null) {
     ...
     */
    protected static Tuple4_Double toTuple(Tuple tuple) {
        if (tuple instanceof Tuple4_Double) {
            return (Tuple4_Double)tuple;
        }
...
//</editor-fold>
     ...
     */
    @FunctionalInterface
    protected static interface ConstructorFunction<T extends Tuple4d> {
        T invoke(double x, double y, double z, double w);
    }
}
